...
class RealtimeClock(object):
    ...
    def __iter__(self):
        ...
        current_time = pd.to_datetime('2/6/2017 18:35:00', utc=True)
        server_time = pd.to_datetime('2/6/2017 18:35:00', utc=True)
        while True:
            current_time = current_time + pd.Timedelta(hours=3)
            server_time = server_time + pd.Timedelta(hours=3)
